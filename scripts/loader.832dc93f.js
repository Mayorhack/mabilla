(function () {
  require.config({
    paths: {
      ...
      webstorage:
        "../bower_components/angular-webstorage/angular-webstorage.min",
      ...
      angularFileUpload:
        "../bower_components/angularjs-file-upload/ng-file-upload.min",
      angularFileUploadShim:
        "../bower_components/angularjs-file-upload/ng-file-upload-shim.min",
      ...
      "tmh.dynamicLocale":
        "../bower_components/angular-dynamic-locale/tmhDynamicLocale.min",
      "webcam-directive":
        "../bower_components/webcam-directive/dist/webcam.min",
      "angular-wizard": "../scripts/modules/angular-wizard",
      "angular-utils-pagination":
        "../bower_components/angular-utils-pagination/dirPagination.min",
    ...
    shim: {
      ...
      notificationWidget: {
        deps: ["angular", "jquery"],
        exports: "notificationWidget",
      },
      angularFileUpload: {
        deps: ["angular", "jquery", "angularFileUploadShim"],
  ...
  require(["mifosXComponents.d4249160", "mifosXStyles.af080b9f"], function (
    componentsInit
  ) {
